...
#define CSR_SSECCFG       0x181
#define CSR_SSECCFGH      0x191
...
CSRS_GEN_ACCESSORS_NAMED(sireg3, CSR_SIREG3);
CSRS_GEN_ACCESSORS_NAMED(sireg4, CSR_SIREG4);
CSRS_GEN_ACCESSORS_NAMED(sireg5, CSR_SIREG5);
CSRS_GEN_ACCESSORS_NAMED(sireg6, CSR_SIREG6);

#if (RV64)
CSRS_GEN_ACCESSORS(time);
CSRS_GEN_ACCESSORS_NAMED(stimecmp, CSR_STIMECMP);
CSRS_GEN_ACCESSORS_NAMED(sseccfg, CSR_SSECCFG);
#else
...
CSRS_GEN_ACCESSORS_NAMED(sseccfgl, CSR_SSECCFG);
CSRS_GEN_ACCESSORS_NAMED(sseccfgh, CSR_SSECCFGH);
CSRS_GEN_ACCESSORS_MERGED(sseccfg, sseccfgl, sseccfgh)
#endif
